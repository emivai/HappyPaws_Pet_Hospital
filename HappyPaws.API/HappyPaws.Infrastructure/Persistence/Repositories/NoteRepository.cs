...
namespace HappyPaws.Infrastructure.Persistence.Repositories
{
    public class NoteRepository : INoteRepository
    {
        ...
        {
            var notes = await _context.Notes.Where(e => e.AppointmentId == appointmentId).Where(e => e.Appointment.PetId == petId).ToListAsync();
            return notes.FirstOrDefault(e => e.Id == noteId);
        }
